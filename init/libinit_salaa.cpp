...
void set_device_props(void){
    ...
    std::string operator_code, device, model, market_name, fingerprint;

    if (ReadFileToString(operator_code_file, &operator_code)) {
    ...
    property_override("bluetooth.device.default_name", market_name);
    property_override("vendor.usb.product_string", market_name);
